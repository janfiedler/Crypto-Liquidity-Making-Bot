...
"budgetLimit": 100
```
Set limit how much you want to spend. This will protect your funds for other strategies. Current pair strategy will spend only the exact maximum defined total amount.

If you set 0, then will be parameter ignored.
```

let config = {
    exchanges: [{
        ...
        pairs: [{name: "IOT-EUR", separator: "-", digitsPrice: 4, digitsSize: 5, buyForAmount: 10, ignoreOrderSize: 1, pipsAskBidSpread: 10, percentageProfitTarget: 0.12, pipsBuySpread: 10}, {name: "BTC-EUR",separator: "-", digitsPrice: 2, digitsSize: 8, buyForAmount: 20, ignoreOrderSize: 0.0, pipsAskBidSpread: 100, percentageProfitTarget: 0.12, pipsBuySpread: 100}],
        ...
        pairs: [{name: "BTC_CZK", separator: "_", digitsPrice: 2, digitsSize: 4, buyForAmount: 50, ignoreOrderSize: 0.0001, pipsAskBidSpread: 2500, percentageProfitTarget: 0.5, pipsBuySpread: 10000}]
    }]
};
